...
public class SqlHelper {
	...
	public static void main(String[] args) {
		...
		map.put("name", "a");
	    System.out.println(getSql("cn.wawi.common.Dao.findUser",map));
	}
	public static String getSql(String namespace,Map<String,Object> param){
		String sql=null;
		SqlSession sqlSession=sqlSessionFactory.openSession();
		try {
			sql=getNamespaceSql(sqlSession,namespace,param);
		} catch (Exception e) {
			e.printStackTrace();
		}finally{
			sqlSession.close();  
