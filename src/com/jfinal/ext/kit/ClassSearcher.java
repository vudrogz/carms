...
public class ClassSearcher {
    ...
    private static <T> List<Class<? extends T>> extraction(Class<T> clazz, List<String> classFileList) {
    	System.out.println("..."+classFileList);
            ...
            for (int i = 0; i < files.length; i++) {
                ...
                if (file.isDirectory()) {
                    ...
                    if (wildcardMatch(targetFileName, file.getName())) {
                     ...
                     //   System.out.println("cn/wawi/common/annotation/Logs.class".replaceAll("/","."));
    ...
    public <T> List<Class<? extends T>> search() {
        ...
        System.out.println("before.."+classFileList);
        ...
        System.out.println("after.."+classFileList);
